...
export const DEFAULT_INVENTORY = [
  ...[
    ...
    "installed-tauri-route-admission.mjs",
    ...
    "stock-maintenance-guest-full.mjs",
    "startup-owner-acceptance.mjs",
  ...
  ...[
    ...
    "delayed-pickup-native-audio-guest-full.test.mjs",
    ...
    "startup-owner-acceptance.test.mjs",
    "local-operations-guest-full.test.mjs",
    "installed-tauri-route-admission.test.mjs",
  ...
  {
    path: "scripts/backend-compose-smoke.mjs",
    owner: "backend-operations",
    category: "verifier-test guard",
    workflows: ["backend deployment"],
  },
  ...
  {
    path: "scripts/windows/install-vem-runtime-owners.ps1",
    owner: "field-operations",
    category: "operator operation",
    workflows: ["runtime acceptance", "testbed workflows"],
  },
  {
    path: "scripts/windows/install-vem-runtime-owners.test.mjs",
    owner: "field-operations",
    category: "verifier-test guard",
    workflows: ["runtime acceptance", "testbed workflows"],
  },
  {
    path: "scripts/windows/install-vem-runtime-owners.windows-harness.ps1",
    owner: "field-operations",
    category: "verifier-test guard",
    workflows: ["runtime acceptance", "testbed workflows"],
  },
  {
    path: "scripts/windows/probe-vem-runtime.windows-harness.ps1",
    owner: "field-operations",
    category: "verifier-test guard",
    workflows: ["runtime acceptance", "testbed workflows"],
  },
  {
    path: "scripts/windows/probe-vem-runtime.ps1",
    owner: "field-operations",
    category: "operator operation",
    workflows: ["runtime acceptance", "testbed workflows"],
  },
