...
test("verifier compares candidate identities against VM, managed-update, and Factory evidence", async () => {
  ...
  try {
      ...
      assets: [
        {
          ...
          signature: {
            ...
            evidenceIdentity: `factory-evidence://sha256/${"1".repeat(64)}`,
          },
          provenance: {
            ...
            buildId: "build",
            signerIdentity: "spki-sha256:" + "2".repeat(64),
            evidenceDigest: `sha256:${"3".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"3".repeat(64)}`,
          },
        },
        {
          ...
          signature: {
            ...
            rootThumbprint: "D".repeat(40),
            evidenceDigest: `sha256:${"4".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"4".repeat(64)}`,
          },
          provenance: {
            predicateType: "https://slsa.dev/provenance/v1",
            sourceIdentity: "src",
            builderIdentity: "builder",
            buildId: "build",
            signerIdentity: "spki-sha256:" + "5".repeat(64),
            evidenceDigest: `sha256:${"6".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"6".repeat(64)}`,
          },
        },
        {
          role: "vem-daemon",
          ...
          signature: {
            ...
            rootThumbprint: "F".repeat(40),
            evidenceDigest: `sha256:${"7".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"7".repeat(64)}`,
          },
          provenance: {
            predicateType: "https://slsa.dev/provenance/v1",
            sourceIdentity: "src",
            builderIdentity: "builder",
            buildId: "build",
            signerIdentity: "spki-sha256:" + "8".repeat(64),
            evidenceDigest: `sha256:${"9".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"9".repeat(64)}`,
          },
        },
        {
          role: "vem-machine-ui",
          ...
          signature: {
            ...
            rootThumbprint: "1".repeat(40),
            evidenceDigest: `sha256:${"a".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"a".repeat(64)}`,
          },
          provenance: {
            predicateType: "https://slsa.dev/provenance/v1",
            sourceIdentity: "src",
            builderIdentity: "builder",
            buildId: "build",
            signerIdentity: "spki-sha256:" + "b".repeat(64),
            evidenceDigest: `sha256:${"c".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"c".repeat(64)}`,
          },
        },
        {
          ...
          signature: {
            scheme: "authenticode-sha256",
            signerThumbprint: "2".repeat(40),
            rootThumbprint: "3".repeat(40),
            evidenceDigest: `sha256:${"d".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"d".repeat(64)}`,
          },
          provenance: {
            predicateType: "https://slsa.dev/provenance/v1",
            sourceIdentity: "src",
            builderIdentity: "builder",
            buildId: "build",
            signerIdentity: "spki-sha256:" + "e".repeat(64),
            evidenceDigest: `sha256:${"f".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"f".repeat(64)}`,
          },
        },
        {
          role: "vision-release",
          ...
          signature: {
            ...
            signerIdentity: "spki-sha256:" + "1".repeat(64),
            evidenceDigest: `sha256:${"2".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"2".repeat(64)}`,
          },
          provenance: {
            predicateType: "https://slsa.dev/provenance/v1",
            sourceIdentity: "src",
            builderIdentity: "builder",
            buildId: "build",
            signerIdentity: "spki-sha256:" + "3".repeat(64),
            evidenceDigest: `sha256:${"4".repeat(64)}`,
            evidenceIdentity: `factory-evidence://sha256/${"4".repeat(64)}`,
          },
          release: {
    ...
    const experimentalAcceptancePath = join(
      dir,
      "experimental-acceptance.json",
    );
    writeFileSync(
      experimentalAcceptancePath,
      `${JSON.stringify({ bundleDigest: vision }, null, 2)}\n`,
    );
    const script = join(
      process.cwd(),
