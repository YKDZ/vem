...
'@
  ...
  Wait-ForSignal -Path $hardWatchdogFaultSignalPath -DeadlineUtc ([DateTime]::UtcNow.AddSeconds(8)) -FailureMessage "hard watchdog host did not validate its unconfirmed cleanup telemetry"
