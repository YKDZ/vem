...
import { AI_SUPPORT_EVIDENCE_SCHEMA } from "./full-workflow-evidence-manifest.ts";
import {
  catalogCategorySelectorForFixture,
  catalogProductSelectorForFixture,
} from "./full-workflow-fixtures.ts";
import { restoreCatalogHomeFromClient } from "./full-workflow-orchestrator.ts";
import { validateAiAttemptSet } from "./full-workflow-validator.ts";
import {
  CdpClient,
...
import { AI_ATTEMPT_ACCEPTANCE_TIMEOUT_MS } from "./try-on-timeouts.ts";
import { collectInstalledAiTryOnAttempt } from "./vision-try-on-acceptance.ts";
