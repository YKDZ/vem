...
import { createScannerCodeDescriptor } from "./vm-host-adapter-contract.ts";
    ...
    try {
      writeFileSync(
        ...
        [
          ...
          " 55 b0 18 2d",
          "< 2026/07/18 08:00:00.700001 length=3",
          " 55 b2 aa",
          "< 2026/07/18 08:00:00.800001 length=3",
          " 55 b3 02",
      ...
      assert.deepEqual(
        ...
        [
          ...
          },
          {
            ...
            rawFrameHex: "55B2AA",
            parsedOpcode: "B2",
            capturedAt: "2026-07-18T08:00:00.700Z",
          },
          {
            direction: "daemon-to-controller",
            rawFrameHex: "55B302",
            parsedOpcode: "B3",
            capturedAt: "2026-07-18T08:00:00.800Z",
          },
          {
            direction: "daemon-to-controller",
