...
'@
    $probeCommand = [Convert]::ToBase64String([Text.Encoding]::Unicode.GetBytes($probeScript))
    $probeOutput = @(& $candidateExecutable -NoProfile -EncodedCommand $probeCommand 2>&1)
